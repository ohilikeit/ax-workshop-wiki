...
|:-----:|------------|----------|:--------:|
| 0 | AI에게 바로 시켜보며 어디서 헷갈리는지 봅니다 | 지금 이 방식으로도 어느 정도 되나? | 10분 |
| 1 | 도메인 지식, 위치, 용어, 예외 규칙을 붙여줍니다 | 어떤 규칙을 설명하면 더 좋아지나? | 20분 |
| 2 | 파싱 흐름을 설계하고 AI가 스스로 교차 검증하며 개발합니다 | 왜 안 되는가, 어느 경로로 가야 하는가? | 40분 |
| 3 | 사람이 직접 확인하고 정답 Excel과 비교합니다 | 실제로 맞는가, 반복 오류는 무엇인가? | 5분 |
| 4 | 지금까지의 흐름을 재사용 가능한 Skill로 만듭니다 | 다른 대학 PDF에도 다시 쓸 수 있는가? | 15분 |
