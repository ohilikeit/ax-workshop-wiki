...
| 4 | **지금까지의 흐름을 재사용 가능한 Skill로 만듭니다** | 15분 | — |

!!! tip "왜 Stage 4(Skill화)가 중요한가요?"
    Stage 0~2는 **이번 한 번** PDF를 Excel로 만드는 과정입니다. Stage 4에서 이 흐름을 Skill로 포장하면, 다음에는 `/recruit-parser 연세대 PDF` 같은 한 마디로 똑같은 작업을 끝낼 수 있습니다. 자동화의 진짜 가치는 **반복 실행**에서 나옵니다.
