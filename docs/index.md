...
실습 1에서는 **텍스트 기반 자동화**(PDF 표에서 데이터 뽑기)를 경험합니다. 실습 2에서는 **이미지 기반 자동화**(PDF 페이지에서 문제 잘라내기)로 넘어갑니다.
...
실습 1에서 이 루프를 텍스트로 연습한 뒤, 실습 2에서 같은 루프를 이미지에 적용합니다. 같은 근육을 다른 무게로 훈련하는 셈입니다.
