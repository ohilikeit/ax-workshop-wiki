...
| ⏱️ 예상 소요 | 📦 핵심 산출물 | ⭐ 난이도 |
|:---:|:---:|:---:|
| 15분 | WORKFLOW.md + Skill 파일 2개 | 보통 |

!!! info ""
    실습 1에서 Skill의 개념과 WORKFLOW.md를 체험했다. 이제 **실제로 쓸 수 있는 Skill**을 만들고, 다른 교재 PDF에 적용해서 범용성을 확인한다.
...
- [ ] 프로젝트 루트에 `WORKFLOW.md`가 있고, 다른 사람이 읽어도 이해할 수 있다
- [ ] Skill 파일이 도구에 맞는 위치에 저장돼 있다
