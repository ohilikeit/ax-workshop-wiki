...
!!! success "실습 목표"
    - 큰 작업을 작은 단계로 쪼개서 AI와 함께 만드는 법을 익힙니다
    - 각 단계마다 눈으로 결과를 확인하고 피드백하는 습관을 기릅니다
    - 완성된 자동화를 Skill로 만들어 재사용합니다

!!! tip "핵심 관점"
    - 한 번에 다 만들려 하지 말고, 단계별로 결과를 눈으로 보며 진행합니다
    - AI한테 "관찰한 규칙"을 자연어로 넘기면 코드로 바꿔줍니다
    - 코드를 읽을 필요 없이, 결과 이미지만 보고 피드백하면 됩니다
